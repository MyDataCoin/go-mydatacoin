...
export default function useIbcCoreClientV1() {
  ...
  return {QueryClientState,QueryClientStates,QueryConsensusState,QueryConsensusStates,QueryClientStatus,QueryClientParams,QueryUpgradedClientState,QueryUpgradedConsensusState,
  }
}